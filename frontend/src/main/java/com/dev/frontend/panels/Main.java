		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					EditContainer productContainer = new EditContainer(new EditProduct(), window);
					EditContainer customerContainer = new EditContainer(new EditCustomer(), window);
					EditContainer salesOrderContainer = new EditContainer(new EditSalesOrder(), window);
