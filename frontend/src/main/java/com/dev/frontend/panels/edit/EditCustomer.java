...
public class EditCustomer extends EditContentPanel {
	...
	public boolean bindToGUI(Object o) {
		if (o != null) {
			...
			txtCreditLimit.setText(String.format("%.2f", customerDto.getCreditLimit()));
			txtCurrentCredit.setText(String.format("%.2f", customerDto.getCurrentCredit()));
			return true;
		}
		return false;
	}
	...
	public Object guiToObject() {
		...
		Double creditLimitF = Double.parseDouble(creditLimit);

		return new CustomerDto(code, name,address, phone1, phone2, creditLimitF);
	}
